      ...
      >
        ...
        <View style={styles.section}>
          ...
          <Text style={[styles.infoText, styles.infoTextSpacingSm]}>
            {`To test deep links on Android: Run \`adb shell am start -W -a android.intent.action.VIEW -d "${deepLinkSchemePrefix}home" com.clitemplate\` in Terminal (replace com.clitemplate with your applicationId).`}
          </Text>
        </View>
